...
function head1(){
window.open("../index.html"//链接
);}

document.all.head2.innerHTML="服务墙"//头部菜单2
function head2(){
window.open("serwall.html"//链接
);}

document.all.head3.innerHTML="视频"//头部菜单3
function head3(){
window.open("../mv/mv2017.html"//链接
);}

document.all.head4.innerHTML="日租房"//头部菜单4
...
function link101(){
window.open("xiaoli.html"//链接
);}

document.all.kind102.innerHTML="公交"//分类1-2标题
function link102(){
window.open("bus.html"//链接
);}

document.all.kind103.innerHTML="地铁"//分类1-3标题
function link103(){
window.open("metro.html"//链接
);}

document.all.kind104.innerHTML="医疗"//分类1-4标题
function link104(){
window.open("medical.html"//链接
);}

document.all.kind105.innerHTML="后勤"//分类1-5标题
function link105(){
window.open("houqin.html"//链接
);}

document.all.kind106.innerHTML="教务"//分类1-6标题
function link106(){
window.open("jwxt.html"//链接
);}

document.all.kind107.innerHTML="电话"//分类1-7标题
function link107(){
window.open("phone.html"//链接
);}

document.all.kind108.innerHTML="地图"//分类1-8标题
function link108(){
window.open("map.html"//链接
);}

document.getElementById("idkind109").style.display="none";//none隐藏
...
function link201(){
window.open("sushequn.html"//链接
);}

document.all.kind202.innerHTML="开网"//分类2-2标题
function link202(){
window.open("network.html"//链接
);}
...
document.all.kind208.innerHTML="夜宵"//分类2-8标题
function link208(){
window.open("../ysjx.html"//链接
);}

document.getElementById("idkind209").style.display="none";//none隐藏
...
document.getElementById("s1").style.display="none";//none隐藏
document.all.slider_101.innerHTML=""//第1行字
document.all.slider_102.innerHTML=""//第2行字
//function links1(){window.open("sushequn.html");}


document.getElementById("s2").style.display="none";//none隐藏
document.all.slider_201.innerHTML="扫描二维码"//第1行字
document.all.slider_202.innerHTML="进入宿舍群"//第2行字
//function links2(){window.open("sushequn.html");}


document.getElementById("s3").style.display="";//none隐藏
document.all.slider_301.innerHTML="扫描二维码"//第1行字
document.all.slider_302.innerHTML="进入宿舍群"//第2行字
function links3(){window.open("sushequn.html");}