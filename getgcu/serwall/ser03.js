...
document.all.title02.innerHTML="网管 黄海宇"//标题
document.all.detail02.innerHTML="2014级"//描述
function phone02(){window.open("tel:18719405345"//长号
);}
function dh02(){window.open("tel:675345"//短号
);}
...
document.all.title03.innerHTML="网管 郑允宏"//标题
document.all.detail03.innerHTML="2014级"//描述
function phone03(){window.open("tel:18826259081"//长号
);}
function dh03(){window.open("tel:649081"//短号
);}
