...
document.all.title02.innerHTML="网管 赖俊民"//标题
document.all.detail02.innerHTML="2017级"//描述
function phone02(){window.open("tel:15814508122"//长号
);}
function dh02(){window.open("tel:668122"//短号
);}
...
document.all.title03.innerHTML="网管 汤子龙"//标题
document.all.detail03.innerHTML="2016级"//描述
function phone03(){window.open("tel:15876519951"//长号
);}
function dh03(){window.open("tel:669951"//短号
);}
...
document.all.title04.innerHTML="网管 简志豪"//标题
document.all.detail04.innerHTML="2016级"//描述
function phone04(){window.open("tel:15217461468"//长号
);}
function dh04(){window.open("tel:661468"//短号
);}
...
document.all.title05.innerHTML="网管 吕道霖"//标题
document.all.detail05.innerHTML="2017级"//描述
function phone05(){window.open("tel:13560494844"//长号
);}
function dh05(){window.open("tel:664844"//短号
);}
