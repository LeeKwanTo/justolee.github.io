...
document.all.title02.innerHTML="网管 苏桦泽"//标题
document.all.detail02.innerHTML="2015级"//描述
function phone02(){window.open("tel:13600463733"//长号
);}
function dh02(){window.open("tel:693733"//短号
);}
...
document.all.title03.innerHTML="网管 黄飞豪"//标题
document.all.detail03.innerHTML="2015级"//描述
function phone03(){window.open("tel:13501489308"//长号
);}
function dh03(){window.open("tel:679308"//短号
);}
...
document.all.title04.innerHTML="网管 邱丰"//标题
document.all.detail04.innerHTML="2015级"//描述
function phone04(){window.open("tel:13902545162"//长号
);}
...
document.all.title05.innerHTML="网管 吕贤文"//标题
document.all.detail05.innerHTML="2015级"//描述
function phone05(){window.open("tel:13560200397"//长号
);}
function dh05(){window.open("tel:670397"//短号
);}
