...
document.all.title02.innerHTML="网管 姚壮彬"//标题
document.all.detail02.innerHTML="2015级"//描述
function phone02(){window.open("tel:13538917322"//长号
);}
function dh02(){window.open("tel:667322"//短号
);}
...
document.all.title03.innerHTML="网管 刘巍然"//标题
document.all.detail03.innerHTML="2016级"//描述
function phone03(){window.open("tel:15820266404"//长号
);}
...
document.all.title04.innerHTML="网管 谢鹏"//标题
document.all.detail04.innerHTML="2017级"//描述
function phone04(){window.open("tel:18475038095"//长号
);}
function dh04(){window.open("tel:18475038095"//短号
);}
