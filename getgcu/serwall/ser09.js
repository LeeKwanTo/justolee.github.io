...
//图片对应编号，例：服务01的图片为01.jpg
//二维码名称为"q+编号"，例：服务01二维码为q01.jpg

//---服务 01
document.getElementById("id01").style.display="none";//none隐藏
document.getElementById("img01").style.display="none";//无图片none
...
document.getElementById("img02").style.display="none";//无图片none
document.all.title02.innerHTML="网管 温锦桐"//标题
document.all.detail02.innerHTML="2016级"//描述
function phone02(){window.open("tel:15217710844"//长号
);}
function dh02(){window.open("tel:660844"//短号
);}
...
document.getElementById("img03").style.display="none";//无图片none
document.all.title03.innerHTML="网管 古敏榆"//标题
document.all.detail03.innerHTML="2016级"//描述
function phone03(){window.open("tel:15217317247"//长号
);}
function dh03(){window.open("tel:"//短号
);}
...
document.getElementById("img04").style.display="none";//无图片none
document.all.title04.innerHTML="网管 梁嘉卓"//标题
document.all.detail04.innerHTML="2016级"//描述
function phone04(){window.open("tel:15217316687"//长号
);}
function dh04(){window.open("tel:666687"//短号
);}
...
document.getElementById("img05").style.display="none";//无图片none
document.all.title05.innerHTML="网管 梁淑莹"//标题
document.all.detail05.innerHTML="2016级"//描述
function phone05(){window.open("tel:15217316910"//长号
);}
function dh05(){window.open("tel:686910"//短号
);}
...
document.getElementById("img06").style.display="none";//无图片none
...
document.getElementById("img07").style.display="none";//无图片none
...
document.getElementById("img08").style.display="none";//无图片none
...
document.getElementById("img09").style.display="none";//无图片none
...
document.getElementById("img10").style.display="none";//无图片none
...
document.getElementById("img11").style.display="none";//无图片none
...
document.getElementById("img12").style.display="none";//无图片none
...
document.getElementById("img13").style.display="none";//无图片none
...
document.getElementById("img15").style.display="none";//无图片none
...
document.getElementById("img16").style.display="none";//无图片none
...
document.getElementById("img17").style.display="none";//无图片none
...
document.getElementById("img18").style.display="none";//无图片none
...
document.getElementById("img19").style.display="none";//无图片none
...
document.getElementById("img20").style.display="none";//无图片none
...
document.getElementById("img21").style.display="none";//无图片none
...
document.getElementById("img22").style.display="none";//无图片none
...
document.getElementById("img23").style.display="none";//无图片none
...
document.getElementById("img24").style.display="none";//无图片none
...
document.getElementById("img25").style.display="none";//无图片none
...
document.getElementById("img26").style.display="none";//无图片none
...
document.getElementById("img27").style.display="none";//无图片none
...
document.getElementById("img28").style.display="none";//无图片none
...
document.getElementById("img29").style.display="none";//无图片none
...
document.getElementById("img30").style.display="none";//无图片none
