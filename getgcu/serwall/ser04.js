...
document.all.title01.innerHTML=""//标题
document.all.detail01.innerHTML=""//描述
function phone01(){window.open("tel:"//长号
);}
function dh01(){window.open("tel:"//短号
);}
document.all.remark01.innerHTML=""//备注


//---服务 02
document.getElementById("id02").style.display="";//none隐藏
document.getElementById("img02").style.display="none";//none隐藏图片
document.all.title02.innerHTML="网管 林于原"//标题
document.all.detail02.innerHTML="2016级"//描述
function phone02(){window.open("tel:15815884443"//长号
);}
function dh02(){window.open("tel:674443"//短号
);}
...
document.all.title03.innerHTML="网管 梁宁"//标题
document.all.detail03.innerHTML="2016级"//描述
function phone03(){window.open("tel:15817096990"//长号
);}
function dh03(){window.open("tel:666990"//短号
);}
...
document.all.title04.innerHTML="网管 李志立"//标题
document.all.detail04.innerHTML="2016级"//描述
function phone04(){window.open("tel:15217227905"//长号
);}
function dh04(){window.open("tel:"//短号
);}
...
document.all.title05.innerHTML="我是大标题5"//标题
document.all.detail05.innerHTML="详情描述"//描述
function phone05(){window.open("tel:13527759662"//长号
);}
function dh05(){window.open("tel:689662"//短号
);}
document.all.remark05.innerHTML="备注"//备注
