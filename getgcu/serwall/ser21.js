...
document.getElementById("img01").style.display="";//无图片none
...
document.all.title02.innerHTML="网管 茹寨华"//标题
document.all.detail02.innerHTML="2015级"//描述
function phone02(){window.open("tel:13424056125"//长号
);}
function dh02(){window.open("tel:676125"//短号
);}
document.all.remark02.innerHTML="备注"//备注


//---服务 03 网管专用
document.getElementById("id03").style.display="none";//none隐藏
document.getElementById("img03").style.display="none";//无图片none
document.all.title03.innerHTML="网管 黄钟贤"//标题
document.all.detail03.innerHTML="2015级"//描述
function phone03(){window.open("tel:13538894804"//长号
);}
function dh03(){window.open("tel:684804"//短号
);}
...
document.all.title04.innerHTML="网管 李家兆"//标题
document.all.detail04.innerHTML="2017级"//描述
function phone04(){window.open("tel:18318342536"//长号
);}
function dh04(){window.open("tel:18318342536"//短号
);}
...
document.all.title05.innerHTML="网管 陈锐"//标题
document.all.detail05.innerHTML="2017级"//描述
function phone05(){window.open("tel:13129647477"//长号
);}
function dh05(){window.open("tel:13129647477"//短号
);}
document.all.remark05.innerHTML=""//备注


//---服务 06
document.getElementById("id06").style.display="";//none隐藏
document.getElementById("img06").style.display="";//无图片none
document.all.title06.innerHTML="鸡肉卷汉堡"//标题
document.all.detail06.innerHTML="鸡肉卷7块，汉堡8块，任选两样送可乐"//描述
function phone06(){window.open("tel:13527759662"//长号
);}
function dh06(){window.open("tel:689662"//短号
);}
document.all.remark06.innerHTML="晚上9点起售"//备注


//---服务 07
document.getElementById("id07").style.display="";//none隐藏
document.getElementById("img07").style.display="none";//无图片none
document.all.title07.innerHTML="网管 卫子敬"//标题
document.all.detail07.innerHTML="2017级"//描述
function phone07(){window.open("tel:13503093428"//长号
);}
function dh07(){window.open("tel:13503093428"//短号
);}
document.all.remark07.innerHTML=""//备注
