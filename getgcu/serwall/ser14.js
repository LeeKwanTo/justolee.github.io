...
document.all.title02.innerHTML="网管 胡婉婷"//标题
document.all.detail02.innerHTML="2014级"//描述
function phone02(){window.open("tel:18826241031"//长号
);}
function dh02(){window.open("tel:661031"//短号
);}
...
document.all.title03.innerHTML="网管 邹颖"//标题
document.all.detail03.innerHTML="2014级"//描述
function phone03(){window.open("tel:18826237246"//长号
);}
function dh03(){window.open("tel:637246"//短号
);}
...
document.all.title04.innerHTML="网管 郑雪华"//标题
document.all.detail04.innerHTML="2014级"//描述
function phone04(){window.open("tel:18826254790"//长号
);}
function dh04(){window.open("tel:664790"//短号
);}
