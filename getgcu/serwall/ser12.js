...
document.all.title02.innerHTML="网管 谭梦娜"//标题
document.all.detail02.innerHTML="2017级"//描述
function phone02(){window.open("tel:18476204850"//长号
);}
function dh02(){window.open("tel:18476204850"//短号
);}
...
document.all.title03.innerHTML="网管 林碧珠"//标题
document.all.detail03.innerHTML="2017级"//描述
function phone03(){window.open("tel:18475030076"//长号
);}
function dh03(){window.open("tel:18475030076"//短号
);}
document.all.remark03.innerHTML="备注"//备注


//---服务 04
document.getElementById("id04").style.display="none";//none隐藏
document.getElementById("img04").style.display="none";//none隐藏图片
document.all.title04.innerHTML="我是大标题"//标题
document.all.detail04.innerHTML="详情描述"//描述
function phone04(){window.open("tel:13527759662"//长号
);}
function dh04(){window.open("tel:689662"//短号
);}
document.all.remark04.innerHTML="备注"//备注


//---服务 05
document.getElementById("id05").style.display="";//none隐藏
document.getElementById("img05").style.display="none";//none隐藏图片
document.all.title05.innerHTML="网管 魏玳琪"//标题
document.all.detail05.innerHTML="2017级"//描述
function phone05(){window.open("tel:18475039469"//长号
);}
function dh05(){window.open("tel:679469"//短号
);}
