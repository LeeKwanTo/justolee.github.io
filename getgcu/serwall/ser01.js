...
document.all.title02.innerHTML="网管郑少栋"//标题
document.all.detail02.innerHTML="2015级"//描述
function phone02(){window.open("tel:13570428204"//长号
);}
function dh02(){window.open("tel:678204"//短号
);}
...
document.all.title03.innerHTML="网管 李峻宇"//标题
document.all.detail03.innerHTML="2017级"//描述
function phone03(){window.open("tel:18475038600"//长号
);}
function dh03(){window.open("tel:18475038600"//短号
);}
...
document.all.title04.innerHTML="网管 郑康跃"//标题
document.all.detail04.innerHTML="2017级"//描述
function phone04(){window.open("tel:13790839017"//长号
);}
function dh04(){window.open("tel:13790839017"//短号
);}
